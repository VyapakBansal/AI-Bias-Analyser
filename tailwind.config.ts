  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        claim: {
          verified: "hsl(var(--claim-verified))",
          partial: "hsl(var(--claim-partial))",
          false: "hsl(var(--claim-false))",
          unverified: "hsl(var(--claim-unverified))",
        },
        highlight: {
          bias: "hsl(var(--bias-highlight))",
          fact: "hsl(var(--fact-highlight))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
